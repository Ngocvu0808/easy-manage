package com.example.customer.utils.response;
...
public class DeleteMethodResponse {
  ...
  public static DeleteMethodResponseBuilder builder() {
    return new DeleteMethodResponseBuilder();
  }
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof DeleteMethodResponse;
  }
  ...
  public static class DeleteMethodResponseBuilder {
    ...
    DeleteMethodResponseBuilder() {
    }

    public DeleteMethodResponseBuilder status(final Boolean status) {
      this.status = status;
      return this;
    }

    public DeleteMethodResponseBuilder message(final String message) {
      this.message = message;
      return this;
    }

    public DeleteMethodResponseBuilder httpCode(final Integer httpCode) {
      this.httpCode = httpCode;
      return this;
    }

    public DeleteMethodResponseBuilder errorCode(final String errorCode) {
      this.errorCode = errorCode;
      return this;
    }

    public DeleteMethodResponse build() {
      return new DeleteMethodResponse(this.status, this.message, this.httpCode, this.errorCode);
    }
