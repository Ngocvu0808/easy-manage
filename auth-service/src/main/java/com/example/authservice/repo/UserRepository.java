...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    void updateStatusListUser(@Param("status") UserStatus status, @Param("updaterId") Integer updaterId, @Param("idList") List<Integer> idList);
    ...
    void updateStatusListUserBlacklist(@Param("status") UserStatus status, @Param("updaterId") Integer updaterId, @Param("idList") List<Integer> idList);
    ...
    void deleteListUserBlacklist(@Param("deleterId") Integer deleterId, @Param("idList") List<Integer> idList);
}
