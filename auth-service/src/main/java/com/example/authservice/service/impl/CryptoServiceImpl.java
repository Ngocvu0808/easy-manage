...
public class CryptoServiceImpl implements CryptoService {
  ...
  public String rsaEncrypt(String data, String base64PublicKey)
  ...
  public String rsaDecrypt(String data, String base64PrivateKey)
  ...
  public String decrypt(String data, String base64PrivateKey)
    ...
    return this.decrypt(Base64.getDecoder().decode(data.getBytes()),
        this.getPrivateKey(base64PrivateKey));
  }
