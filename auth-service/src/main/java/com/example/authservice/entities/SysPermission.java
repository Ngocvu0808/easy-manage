...
public class SysPermission extends BaseEntity<Integer> implements Serializable {
    ...
    public String toString() {
        return "SysPermission(id=" + this.getId() + ", api=" + this.getApi() + ", method=" + this.getMethod() + ", code=" + this.getCode() + ", name=" + this.getName() + ", service=" + this.getService() + ", objectCode=" + this.getObjectCode() + ", objectName=" + this.getObjectName() + ")";
    }
}
