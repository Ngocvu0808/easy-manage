...
public class RoleObject extends BaseEntity<Integer> {
  ...
  public String toString() {
    return "RoleObject(id=" + this.getId() + ", serviceName=" + this.getServiceName()
        + ", objectId=" + this.getObjectId() + ", roleId=" + this.getRoleId() + ", userId="
        + this.getUserId() + ", user=" + this.getUser() + ", role=" + this.getRole() + ")";
  }
}
